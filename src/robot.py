...
class Robot:
    def __init__(self):
        ...
        self.right_drive = Motor(PORT_RIGHT_DRIVE, positive_direction=Direction.COUNTERCLOCKWISE)
        self.left_drive = Motor(PORT_LEFT_DRIVE, positive_direction=Direction.CLOCKWISE)
